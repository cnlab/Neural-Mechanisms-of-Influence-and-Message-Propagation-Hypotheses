...
params:
  summary: TRUE
  hnum: "H6.1"
  htitle: "Value of expression and sharing behavior"
---
...
```{r, echo=FALSE}
md<-lm(rating~veq,data=language_id)
...
| --------------------------------------------------- | --- |
| `r ifelse(params$summary,paste0('**',params$hnum,'**'),paste0('[**', params$hnum, "**](hypotheses/H5.1.md)'"))`: The higher a participant places the value of expression, the more likely they are to share articles, irrespective of the audience condition. | Not Significant  `r stat_str` |
